...
\begin{figure}[h]
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		\small (a) Pablo
		\\[0.05em]
		\includegraphics[width=\linewidth,height=0.30\textheight,keepaspectratio,trim=0 700 0 1700,clip]{grafiken/IMG_1502.png}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.48\textwidth}
		\centering
		...
		\\[0.3em]
		\includegraphics[width=0.34\linewidth,height=0.145\textheight,keepaspectratio]{grafiken/idle_1.jpeg}
		\vspace{0.2em}
		\includegraphics[width=0.34\linewidth,height=0.145\textheight,keepaspectratio]{grafiken/thinking.jpeg}

		\vspace{0.1em}

		\includegraphics[width=0.34\linewidth,height=0.145\textheight,keepaspectratio]{grafiken/speaking_2.jpeg}
		\vspace{0.5em}
		\includegraphics[width=0.34\linewidth,height=0.145\textheight,keepaspectratio]{grafiken/blinking.jpeg}
	\end{minipage}
