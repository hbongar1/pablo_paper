...
Diese Entwicklung hat die Erwartungen an digitale Assistenzsysteme nachhaltig verändert: Nutzende setzen zunehmend voraus, dass Systeme nicht nur einzelne Befehle ausführen, sondern flexibel auf offene Fragestellungen reagieren und sich in individuelle Arbeitsabläufe einfügen.

Trotz der breiten Verbreitung sprachbasierter Assistenten bestehen wesentliche Einschränkungen, die deren Einsatz im persönlichen Umfeld begrenzen.
...
Ein Assistenzsystem, das als greifbares, sichtbares Gegenüber im Alltag wahrgenommen wird, besitzt demnach ein qualitativ anderes Interaktionspotenzial als ein reiner Softwareagent.
...
Im Unterschied zu bestehenden Systemen verfolgt Pablo einen bewusst modularen und offenen Ansatz: Durch eine Plugin-basierte Softwarearchitektur können Funktionsmodule -- etwa Notiz- und Kalenderverwaltung, Timer oder Wetterabfragen -- bedarfsgerecht ergänzt und individuell angepasst werden, ohne den Kernprozess verändern zu müssen.
Die zugrunde liegende Hardware basiert auf einem Raspberry Pi und ermöglicht eine kostengünstige, eigenständige Umsetzung.
...
Die vorliegende Dokumentation beschreibt den vollständigen Entwicklungsprozess -- von der Konzeption über die Hard- und Softwareentwicklung bis hin zur Integration und Evaluierung des Gesamtsystems.
Dabei orientiert sich die Entwicklung methodisch an der VDI~2221/2206 und gliedert sich in klar definierte Projektphasen.
